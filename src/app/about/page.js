    ...
    <div className="container">
      <section className="page-header">
        ...
        <p className="page-desc">
          I build AI assistants, automations, and web applications.
        </p>
      </section>

      <div className="bento-grid">
        <div className="bento-box col-span-12">
          <h2 style={{ fontSize: '1.5rem', fontWeight: '700', marginBottom: '1rem' }}>My Background</h2>
          <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem', lineHeight: '1.8' }}>
            I am an AI and automation developer based in Karachi. I work with teams in logistics, healthcare, real estate, and aviation to automate routine tasks and make information easier to use. 
            <br/><br/>
